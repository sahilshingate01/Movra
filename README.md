...
## Core Features & Logic
* **Context-Aware AI Chat Engine:** Uses Google Gemini 2.5 Flash with role-specific system prompts. The AI understands the user's current role and tailor responses appropriately (e.g., giving fans directions vs giving staff security protocols).
...
1. **API Key Protection:** The Gemini API key remains securely on the server via Next.js API Routes (`/api/chat`).
...
* The AI responses are based on the training data of Gemini 2.5 and our robust system prompts.
