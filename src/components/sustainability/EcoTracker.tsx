...
/**
 * Sustainability Eco Tracker widget.
 * Displays the fan's estimated matchday carbon footprint and
 * nearby sustainability amenities (water refill stations, recycling bins).
 */
const EcoTracker = memo(function EcoTracker() {
    ...
    <div className="flex flex-col h-full bg-canvas p-4 text-ink">
      <div className="flex items-center justify-between mb-4">
        <h3 className="font-semibold flex items-center gap-2 text-body-md-strong text-ink">
          <Leaf size={18} className="text-cyan" aria-hidden="true" />
          Eco Tracker
        </h3>
      </div>
      ...
      <div className="p-4 bg-canvas-soft border border-hairline rounded-md mb-4 text-center">
        ...
        <div className="flex items-baseline justify-center gap-1">
          <span className="text-display-lg text-cyan" aria-label={`${footprint} kilograms of CO2`}>
            {footprint}
          </span>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="p-3 bg-canvas-soft border border-hairline rounded-md flex flex-col items-center text-center gap-2">
          <Droplets size={20} className="text-link" aria-hidden="true" />
          <div>
        ...
        <div className="p-3 bg-canvas-soft border border-hairline rounded-md flex flex-col items-center text-center gap-2">
          <Recycle size={20} className="text-cyan" aria-hidden="true" />
          <div>
